...
int main() {
    ...
    do {
        ...
        std::cout << "5.  Display Directory Structure\n";
        std::cout << "6.  Undo previous action\n";
        std::cout << "7.  Display contents of a specified directory\n";
        std::cout << "8.  Rename a directory\n";
        std::cout << "9. Copy a file\n";
        std::cout << "10. Sort a specified directory\n";
        std::cout << "11. Exit\n";
